...
const (
	QUALITY_BAD           uint8 = 0x00
	QUALITY_UNCERTAIN     uint8 = 0x01
	QUALITY_NOT_CONNECTED uint8 = 0x02
	QUALITY_NOT_RESPONSE  uint8 = 0x03
	QUALITY_GOOD          uint8 = 0xc0
)
...
//func (r *GoField) UnmarshalJSON(data []byte) error {
...
//func (r *GoField) MarshalJSON() ([]byte, error) {
//	status := "Good"
